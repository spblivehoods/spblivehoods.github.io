...
var style_Recriation_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Outdoors & Recreation");
    var labelText = "";
    size = 0;
    ...
    if (value > 7.000000 && value <= 67.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 67.800000 && value <= 128.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 128.600000 && value <= 189.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 189.400000 && value <= 250.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 250.200000 && value <= 311.000000) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_Recriation_5.getSource().getFeatures();
